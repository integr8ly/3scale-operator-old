...
func newReconciler(mgr manager.Manager) reconcile.Reconciler {
	return &ReconcileThreeScaleTenant{client: mgr.GetClient(), scheme: mgr.GetScheme()}
}
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ThreeScaleTenant
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &threescalev1alpha1.ThreeScaleTenant{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileThreeScaleTenant) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set ThreeScaleTenant instance as the owner and controller
...
func newPodForCR(cr *threescalev1alpha1.ThreeScaleTenant) *corev1.Pod {
